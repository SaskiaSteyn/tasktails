 ...
 *
 * Display only: there's no click handler on the circle here. Toggling
 * completion is TASK-05, wired to TASK-11's reward calculation — a row that
 * looked interactive but did nothing would be worse than one that plainly
 * isn't yet.
 *
