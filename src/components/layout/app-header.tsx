  ...
  return (
    <header
      className={cn(
        ...
        //
        // **Regression, fixed 2026-08-12**: this had silently flattened to
        // `pt-[14px]` (an unrelated commit touching pet visuals), which this
        // very comment kept describing as still doing the inset add — restored
